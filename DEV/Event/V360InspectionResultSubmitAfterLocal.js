/*------------------------------------------------------------------------------------------------------/
| SVN $Id: V360InspectionResultSubmitAfterLocal.js
| Program : V360InspectionResultSubmitAfterV.js
| Event   : V360InspectionResultSubmitAfter
|
| Usage   : Master Script to be used instead of V360InspectionResultSubmitAfter.js by Accela.
|
| Client  : N/A
| Action# : N/A
|
| Notes   : This version fixes the null cap object that comes from INCLUDES_ACCELA_GLOBALS Lines(159 - 163)
|
|
/------------------------------------------------------------------------------------------------------*/
/*------------------------------------------------------------------------------------------------------/
...
for (sol in solutionInc) {
	if (solutionInc[sol].getAuditStatus() != "I")
		eval(getScriptText(solutionInc[sol].getBizdomainValue(), null));
}
...
for (rule in configRules) {
	if (configRules[rule].getAuditStatus() != "I")
		eval(getScriptText(configRules[rule].getBizdomainValue(), null));
}
