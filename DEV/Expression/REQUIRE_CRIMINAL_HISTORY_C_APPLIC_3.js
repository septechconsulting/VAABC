/*------------------------------------------------------------------------------------------------------/
| Program		: REQUIRE_CRIMINAL_HISTORY_C_APPLIC_3.js
| Event			: Expression
|
| Usage			: 
...
var variable0 = expression.getValue("CONTACT3TPLTABLE::ABC_C_APPLIC::CRIMINAL OFFENSES::FORM");
var variable1 = expression.getValue("CONTACT3TPLFORM::ABC_C_APPLIC::BACKGROUND INFORMATION::Have you been convicted of any alcohol related offenses including DUI");
var variable2 = expression.getValue("CONTACT3TPLFORM::ABC_C_APPLIC::BACKGROUND INFORMATION::Have you been convicted of any other criminal offense");
var variable3 = expression.getValue("CONTACT3TPLTABLE::ABC_C_APPLIC::CRIMINAL OFFENSES::Date of Offense");
