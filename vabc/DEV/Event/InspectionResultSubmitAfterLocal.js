/*------------------------------------------------------------------------------------------------------/
| SVN $Id: InspectionResultSubmitAfterLocal.js 
| Program : InspectionResultSubmitAfterV.js
| Event   : InspectionResultSubmitAfter
|
| Usage   : Master Script to be used instead of InspectionResultSubmitAfter by Accela.
|
| Client  : N/A
| Action# : N/A
|
| Notes   : This version fixes the null cap object that comes from INCLUDES_ACCELA_GLOBALS Lines(71 - 75)
|
|
/------------------------------------------------------------------------------------------------------*/
/*------------------------------------------------------------------------------------------------------/
