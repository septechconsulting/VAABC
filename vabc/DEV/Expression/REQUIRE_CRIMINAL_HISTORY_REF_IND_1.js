/*------------------------------------------------------------------------------------------------------/
| Program		: REQUIRE_CRIMINAL_HISTORY_REF_IND_1.js
| Event			: Expression
|
| Usage			: 
...
var variable0 = expression.getValue("CONTACT1TPLTABLE::ABC_REF_IND::CRIMINAL OFFENSES::FORM");
var variable1 = expression.getValue("CONTACT1TPLFORM::ABC_REF_IND::BACKGROUND INFORMATION::Have you been convicted of any alcohol related offenses including DUI");
var variable2 = expression.getValue("CONTACT1TPLFORM::ABC_REF_IND::BACKGROUND INFORMATION::Have you been convicted of any other criminal offense");
var variable3 = expression.getValue("CONTACT1TPLTABLE::ABC_REF_IND::CRIMINAL OFFENSES::Date of Offense");
