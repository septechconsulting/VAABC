/*------------------------------------------------------------------------------------------------------/
| Program		: REQUIRE_CRIMINAL_HISTORY_REF_IND_3.js
| Event			: Expression
|
| Usage			: 
...
var variable0 = expression.getValue("CONTACT3TPLTABLE::ABC_REF_IND::CRIMINAL OFFENSES::FORM");
var variable1 = expression.getValue("CONTACT3TPLFORM::ABC_REF_IND::BACKGROUND INFORMATION::Have you been convicted of any alcohol related offenses including DUI");
var variable2 = expression.getValue("CONTACT3TPLFORM::ABC_REF_IND::BACKGROUND INFORMATION::Have you been convicted of any other criminal offense");
var variable3 = expression.getValue("CONTACT3TPLTABLE::ABC_REF_IND::CRIMINAL OFFENSES::Date of Offense");
